...
if _G.sqge then
for r,t in next,_G.sqge do
for c,e in next,t do
e:Disconnect()
end
end
end
...
for c=1,COLS do
local o=get(r,c)
if not o or R<0 then R=-1 break end
evts[r][c]=o.Touched:connect(function(p)
...
save(r,c)
elseif(not hl or not mg)and COLS==2 then save(r,3-c)end
chrs[ch]=r
